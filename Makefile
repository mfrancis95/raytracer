...
software_renderer: camera.o main.o renderer.o sphere.o software_renderer.o vector.o
	g++ $(FLAGS) -o software_renderer camera.o main.o renderer.o sphere.o software_renderer.o vector.o -lGL -lSDL2
